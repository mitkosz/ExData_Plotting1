#plot4.R plots the assignment plot4 into a plot4.png file into the working directory
...
par(mfrow = c(2,2))
with(feb,{
  plot(DateTime, Global_active_power, type = "n", ylab = "Gloal Active Power", xlab = "")
  ...
  plot(DateTime, Global_reactive_power, type = "n", ylab = "Gloal_rective_power", xlab = "datetime")
