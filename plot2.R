#plot2.R plots the assignment plot2 into a plot2.png file into the working directory
...
#make the plot and and print it in png file
png("plot2.png")#png default height is 480 and default width is 480 pixels, no need to specify explicitly
